            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <a class="btn btn-primary" href="{{ route('transaction') }}">Transaction History</a>
                        <a class="btn btn-success" href="#" data-toggle="modal" data-target="#addTransaction">New Transaction</a>
                    </div>
